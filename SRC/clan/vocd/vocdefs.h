...
#define CMD_LINE_MAX  1024      /* max no of chars in the expanded command line - for summarising the command line in the output  */
#define MAX_CMDNAME   100       /* max length of command name      */ 
#define MAX_EXT        10       /* max len of o/p file extension   */
#define MAX_POSTCODES  10       /* maximum number of postcodes allowed in the command line     */
...
#define MAX_TRIALS      3       /* number of trials to compute D_optimum */
