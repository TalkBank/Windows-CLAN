...
BEGIN_EVENTSINK_MAP(CMpegDlg, CDialog)
    //{{AFX_EVENTSINK_MAP(CMpegDlg)
	ON_EVENT(CMpegDlg, IDC_MEDIAPLAYER1, 3012 /* PlayStateChange */, OnPlayStateChangeMediaplayer1, VTS_I4 VTS_I4)
	ON_EVENT(CMpegDlg, IDC_MEDIAPLAYER1, 2 /* PositionChange */, OnPositionChangeMediaplayer1, VTS_R8 VTS_R8)
	ON_EVENT(CMpegDlg, IDC_MEDIAPLAYER1, 3011 /* OpenStateChange */, OnOpenStateChangeMediaplayer1, VTS_I4 VTS_I4)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()
...
void CMpegDlg::OnPositionChangeMediaplayer1(double oldPosition, double newPosition) 
{
	if (!playing){
		long cp;
...
void CMpegDlg ::changeMovieWinSize(long DisplaySize, BOOL isSetOrgSize) {
...
void CMpegDlg::OnOpenStateChangeMediaplayer1(long OldState, long NewState) 
{
...
void CMpegDlg::ResizeMovie(short w, short isRedo, BOOL isRefreshMPG) {
	double ratio, th, tw;
...
void CMpegDlg::OnPlayStateChangeMediaplayer1(long OldState, long NewState) 
{
	int i=0;
...
*/
	hr = m_spWMPPlayer->put_URL(fname);
...
void CMpegDlg::OnChangeCursorPos() 
{
/*
	if (opened){
		if (!playing)
...
void CMpegDlg::OnClose() 
{
	// TODO: Add your message handler code here and/or call default
	CDialog::OnClose();
}

BOOL CMpegDlg::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult) 
{
